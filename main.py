...
class SubButton(discord.ui.View):
    def __init__(self):
        ...
        botaourl = discord.ui.Button(label="mães solteiras a 500 metros",url="https://www.youtube.com/watch?v=bu5wuKGriMw")
...
async def sync(ctx,guild=None):
    ...
    await ctx.send("**MÃES SOLTEIRAS A 500 metros",view=SubButton())
